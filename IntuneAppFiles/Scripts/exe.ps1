...
Add-IntuneWin32App -FilePath $IntuneWinFile -DisplayName $DisplayName -Description "VSCode is here, it's .exe file Install" -Publisher "VSCode" -InstallExperience "system" -RestartBehavior "suppress" -DetectionRule $DetectionRule -RequirementRule $RequirementRule -InstallCommandLine $InstallCommandLine -UninstallCommandLine $UninstallCommandLine -Verbose
